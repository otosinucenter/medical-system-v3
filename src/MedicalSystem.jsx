              ...
              trashedAppointments.length === 0 ? <p className="text-center text-gray-400 italic py-8">No hay citas en la papelera.</p> : (
                <div className="space-y-2">
                  {trashedAppointments.map(item => (
                    <div key={item.id} className="bg-red-50 p-3 rounded border border-red-100 flex justify-between items-center hover:shadow-sm transition-shadow">
                      <div>
                      ...
                      <div className="flex gap-2">
                        <button onClick={() => restoreAppointment(item.id)} className="text-xs bg-green-100 text-green-700 px-3 py-1 rounded hover:bg-green-200 font-bold border border-green-200">Restaurar</button>
                        <button onClick={() => deleteAppointmentPermanently(item.id)} className="text-xs bg-red-600 text-white px-3 py-1 rounded hover:bg-red-700 font-bold shadow-sm">Eliminar</button>
                      </div>
                    </div>
                  ))}
                </div>
                ...
                <div className="space-y-2">
                  {trashedPatients.map(item => (
                    <div key={item.id} className="bg-red-50 p-3 rounded border border-red-100 flex justify-between items-center hover:shadow-sm transition-shadow">
                      ...
                      <div className="flex gap-2">
                        <button onClick={() => restorePatient(item.id)} className="text-xs bg-green-100 text-green-700 px-3 py-1 rounded hover:bg-green-200 font-bold border border-green-200">Restaurar</button>
                        <button onClick={() => deletePatientPermanently(item.id)} className="text-xs bg-red-600 text-white px-3 py-1 rounded hover:bg-red-700 font-bold shadow-sm">Eliminar</button>
                      </div>
                    </div>
                  ))}
                </div>
